...
class RadarReader:
    def __init__(self, port, baud):
        ...
        self.recent_distances = deque(maxlen=10)  # short buffer for fusion
    ...
    def _parse_frame_a(self, frame):
        ...
        with self.lock:
            ...
            if present:
                self.recent_distances.append(distance_cm / 100.0)
    ...
    def get_data(self):
        with self.lock:
            return {
                ...
                'recent_distances': list(self.recent_distances),
